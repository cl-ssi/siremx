                    ...
                    <form role="form">
                      <div class="form-row">
                        <fieldset class="form-group col-12">
                          ...
                          <input type="text" class="form-control" v-model="fillCreateRole.name"
                            @keyup.enter="setAddRole">
                        </fieldset>
                      </div>
                      <div class="form-row">
                        <fieldset class="form-group col-12">
                          <label>Url Amigable</label>
                          <input type="text" class="form-control" v-model="fillCreateRole.slug"
                            @keyup.enter="setAddRole">
                  ...
                  <div class="card-body">
                    <template v-if="listPermissionsFilter.length">
                      <table
                        ...
                        <tbody>
                          <tr v-for="(item, index) in listPermissionsFilter" :key="index"
                            @click.prevent="checkRow(index)">
                            <td>
