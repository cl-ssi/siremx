              ...
              <template v-if="listRolePermissionsByUser.includes('establishment.filter')">
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <div class="col-md-9">
                      <el-select v-model="fillBsqReport.establishmentRequest" filterable placeholder="Seleccione"
                        multiple clearable>
                        <el-option v-for="item in listEstablishments" :key="item.id"
                          :label="item.new_code_deis + ' - ' + item.alias" :value="item.new_code_deis">
                        </el-option>
                      </el-select>
                    </div>
                  </div>
            ...
            <div class="row">
              <template v-if="listRolePermissionsByUser.includes('establishmentExam.filter')">
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <div class="col-md-9">
                      <el-select v-model="fillBsqReport.establishmentExam" filterable placeholder="Seleccione"
                        clearable>
                        <el-option v-for="item in listEstablishments" :key="item.id"
                          :label="item.new_code_deis + ' - ' + item.alias" :value="item.new_code_deis">
                        </el-option>
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <div class="col-md-9">
                    <el-select v-model="fillBsqReport.selectExamType" placeholder="Seleccione" multiple clearable>
                      <el-option v-for="item in listExamType" :key="item.value" :label="item.label" :value="item.value">
                      </el-option>
                    </el-select>
                  </div>
                </div>
          ...
          <template v-if="listBirardsMamAgeMX.length">
            <table id="data-table"
              ...
              <thead class=" text-nowrap">
                <tr>
                  <th colspan="11" class="text-center bordered align-middle table-default">BIRARDS POR RANGO DE EDAD
                    MAMOGRAFÍA</th>
                </tr>
          ...
          <template v-if="listarUsuariosPaginated.length">
            <table id="data-table"
              ...
              <tr class="small " v-for="(item, index) in listarUsuariosPaginated" :key="index">
                ...
                <td class="text-center align-middle">{{ item.birards_mamografia }}</td>
                <td class="text-center align-middle">{{ item.birards_ecografia }}</td>
                <td class="text-center align-middle">{{ item.birards_proyeccion }}</td>
                <td>{{ $1 }}</td>
              </tr>
            </table>
            <div class="card-footer clearfix">
