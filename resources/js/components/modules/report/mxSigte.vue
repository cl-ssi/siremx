      ...
      <div class="container-fluid">
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <div class="col-md-9">
                      <el-select v-model="fillBsqReport.type" placeholder="Seleccione" clearable>
        ...
        <div class="card card-secondary">
          <div class="card-header">
            ...
            <div class="card-tools">
              <button type="button" data-card-widget="collapse" data-toggle="tooltip" title="Collapse"
                class="btn btn-tool"><i class="fas fa-minus"></i></button>
            </div>
          </div>
          <div class="card-body">
            <form role="form">
