                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <div class="col-md-9">
                          <el-slider v-model="fillBsqReport.year" :step="12" :min="12" :max="60" :marks="marks"
                            show-stops>
                          </el-slider>
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9">
                          <el-select v-model="fillBsqReport.selectExamType" placeholder="Seleccione" multiple clearable>
                            <el-option v-for="item in listExamType" :key="item.value" :label="item.label"
                              :value="item.value">
                            </el-option>
                          </el-select>
                        </div>
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <div class="col-md-9">
                          <el-select v-model="fillBsqReport.selectBIRADS" placeholder="Seleccione" clearable>
                            <el-option v-for="item in listBIRADS" :key="item.value" :label="item.label"
                              :value="item.value">
                            </el-option>
                          </el-select>
                        </div>
